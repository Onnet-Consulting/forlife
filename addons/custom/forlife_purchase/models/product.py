...
class ProductProduct(models.Model):
    ...
    def _search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
        if (self._context.get('purchase_type') == 'service' and self._context.get('type_po_cost') == 'cost'
                and self.env.user.has_group('forlife_purchase.purchase_order_service_limit')):
