...
class PurchaseOrder(models.Model):
    ...
    occasion_code_ids = fields.Many2many('occasion.code', relation='occasion_code_rel', string="Case Code")
    account_analytic_ids = fields.Many2many('account.analytic.account', relation='account_analytic_rel', string="Cost Center")
