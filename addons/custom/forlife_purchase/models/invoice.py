        ...
        landed_costs = self.env['stock.landed.cost'].create({
            ...
            'cost_lines': [(0, 0, {
                ...
                'price_unit': l.currency_id._convert(l.price_subtotal, l.company_currency_id, l.company_id,
                                                     l.move_id.date) if not l.move_id.apply_manual_currency_exchange and not l.move_id.active_manual_currency_rate else l.price_unit / (
                            1 / l.move_id.manual_currency_exchange_rate),
