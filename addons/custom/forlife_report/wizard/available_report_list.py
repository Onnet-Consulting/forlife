...
AVAILABLE_REPORT = {
    'report.num2': {
        'module': 'Kho',
        'name': 'Báo cáo tồn kho theo giá bán',
    ...
    'report.num3': {
        'module': 'Kho',
        'name': 'Báo cáo tồn kho theo chi nhánh_khu vực',
    ...
    'report.num4': {
        'module': 'Kho',
        'name': 'Báo cáo tồn kho theo sản phẩm',
    ...
    'report.num6': {
        'module': 'Bán hàng',
        'name': 'Báo cáo bán - trưng hàng',
        'reportTemplate': 'ReportNum6Template',
        'reportPager': True,
    },
    'report.num7': {
        'module': 'Bán hàng',
        'name': 'Báo cáo doanh thu tại cửa hàng theo dòng hàng',
        'reportTemplate': 'ReportNum7Template',
        'reportPager': True,
    },
    'report.num8': {
        'module': 'Bán hàng',
        'name': 'Báo cáo chi tiết hóa đơn áp dụng voucher',
        'reportTemplate': 'ReportNum8Template',
        'reportPager': True,
    },
    'report.num9': {
        'module': 'Bán hàng',
        'name': 'Báo cáo voucher phát hành',
    ...
    'report.num12': {
        'module': 'Bán hàng',
        'name': 'Báo cáo khách hàng không mua hàng',
        'reportTemplate': 'ReportNum12Template',
        'tag': 'report_num12_action',
    },
    'report.num13': {
        'module': 'Mua hàng',
        'name': 'Báo cáo tình hình thực hiện đơn hàng mua',
    ...
    'report.num16': {
        'module': 'Kho',
        'name': 'Báo cáo chi tiết xuất nhập hàng',
    ...
    'report.num21': {
        'module': 'Kho',
        'name': 'Báo cáo chi tiết hàng hóa luân chuyển',
