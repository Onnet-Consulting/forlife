...
order by num
    ...
    def generate_xlsx_report(self, workbook, allowed_company):
        ...
        for value in data['data']:
            ...
            sheet.write(row, 3, value.get('texture'), formats.get('normal_format'))
            sheet.write(row, 4, value.get('season'), formats.get('normal_format'))
            sheet.write(row, 5, value.get('gender'), formats.get('normal_format'))
            sheet.write(row, 6, value.get('product_barcode'), formats.get('normal_format'))
            sheet.write(row, 7, value.get('product_name'), formats.get('normal_format'))
            sheet.write(row, 8, value.get('uom_name'), formats.get('normal_format'))
            sheet.write(row, 9, value.get('color'), formats.get('normal_format'))
            sheet.write(row, 10, value.get('size'), formats.get('normal_format'))
            sheet.write(row, 11, value.get('label'), formats.get('normal_format'))
            sheet.write(row, 12, value.get('total_qty'), formats.get('float_number_format'))
            sheet.write(row, 13, value.get('total_pending'), formats.get('float_number_format'))
            col = 14
