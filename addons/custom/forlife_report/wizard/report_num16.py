...
class ReportNum16(models.TransientModel):
    ...
    _description = 'Báo cáo chi tiết xuất nhập hàng'
...
"""
    ...
    def get_data(self, allowed_company):
        ...
        Product = self.env['product.product'].with_context(report_ctx='report.num16,product.product')
        Warehouse = self.env['stock.warehouse'].with_context(report_ctx='report.num16,stock.warehouse')
