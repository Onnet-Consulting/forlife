...
class ResConfigSettings(models.TransientModel):
    ...
    mssql_database = fields.Char(string='Database', config_parameter="mssql.database", required=True)
    mssql_username = fields.Char(string='Username', config_parameter="mssql.username", default='sa', required=True)
    mssql_password = fields.Char(string='Password', config_parameter="mssql.password", required=True)
