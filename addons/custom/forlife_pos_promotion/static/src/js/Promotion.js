...
//    }
    ...
    */
    ...
    _computeNewPriceForComboProgram(disc_total, base_total, prePrice, quantity) {
        ...
        let discAmount = round_decimals( discAmountInLine / quantity, this.env.pos.currency.decimal_places);
        let newPrice = round_decimals( (subTotalLine - discAmountInLine) / quantity, this.env.pos.currency.decimal_places);
