odoo.define('stock_inventory.InventoryValidationController', function (require) {
"use strict";
        ...
        prom.then(function () {
            self._rpc({
                ...
                var exitCallback = function (infos) {
                    ...
                    self.displayNotification({ message: _t("Kiểm kê đã được xác nhận") , type: 'success'});
