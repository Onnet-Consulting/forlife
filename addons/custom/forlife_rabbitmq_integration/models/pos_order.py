    ...
    def get_sync_create_data(self):
        ...
        for order in self:
            ...
            data.append({
                ...
                'store': {
                    'store_id': order.config_id.store_id.warehouse_id.id or None,
                    'store_name': order.config_id.store_id.warehouse_id.name or None,
                },
                'customer': {
                ...
                'payment_method': [pay.payment_method_id.name for pay in order.payment_ids],
                'order_date': order_date,
                'payment_date': order_date,
                'delivery_date': order_date,
                'complete_date': order_date,
                'coupons': [coupon.name for coupon in order.mapped('lines.promotion_usage_ids.code_id')] or None,
                'brand': order.brand_id.name or None,
            })
        return data
