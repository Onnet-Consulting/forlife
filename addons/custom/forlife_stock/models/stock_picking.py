    ...
    def action_confirm(self):
        for picking in self:
            for line in picking.move_ids:
                ...
                if (picking.other_export and account != picking.location_dest_id.with_company(picking.company_id).x_property_valuation_out_account_id.id) or (
                        picking.other_import and account != picking.location_id.with_company(picking.company_id).x_property_valuation_in_account_id.id):
