...
class StockTransferRequest(models.Model):
    ...
    location_id = fields.Many2one('stock.location', "Từ kho", check_company=True, domain=[('virtual_location_ch', '=', False)])
    location_dest_id = fields.Many2one('stock.location', "Đến kho", check_company=True, domain=[('virtual_location_ch', '=', False)])
