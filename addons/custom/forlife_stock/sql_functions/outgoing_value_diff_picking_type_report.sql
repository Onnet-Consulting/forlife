DROP FUNCTION IF EXISTS outgoing_value_diff_report_picking_type;
CREATE OR REPLACE FUNCTION outgoing_value_diff_report_picking_type(_date_from character varying , _date_to character varying, _company_id integer)
RETURNS TABLE
        (
            product_id               INTEGER,
...
$BODY$;
-- select * from outgoing_value_diff_report_picking_type('2023-01-31 23:00:00', '2023-02-19 22:59:59', 1)
